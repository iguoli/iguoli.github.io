...
*bar.example.com* 的 CNAME 是 *foo.example.com*，CNAME 的意思是 **真实名称**，而右侧才是真实名称，才是 **CNAME**。上面的 CNAME 记录应当读作： *bar.example.com* 的真实名称是 *foo.example.com*。请求访问 *bar.example.com* 的客户端会得到 *foo.example.com* 返回的结果。
