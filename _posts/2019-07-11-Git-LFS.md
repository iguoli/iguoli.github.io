...
tags: Git
key: 2019-07-11-Git-LFS
---

## Git LFS 简介

Git LFS 是由 Atlassian, GitHub 和其他开源贡献者开发的 Git 扩展，目的是减少大文件对 Git 仓库的影响，其以一种 ***偷懒*** 的方式下载相关版本的文件，具体来讲，就是只有在执行 `checkout` 命令时才会下载文件，而 `clone` 或 `fetch` 均不会下载文件。
...
[Git LFS Tutorial](https://www.atlassian.com/git/tutorials/git-lfs#installing-git-lfs)